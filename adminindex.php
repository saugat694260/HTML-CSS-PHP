...
<body>
    ...
    <div class="sub">
        <div class="a"><a href="addproduct.php" style="text-decoration: none;color: black;">add product</a></div>

        <div class="a"><a href="members.php" style="text-decoration: none;color: black;">users</a></div>

    </div>
    <p style="text-align: center;font-size: 20px;">welcome sir
        <?php echo $admin_data['user_name']; ?>!!<br>
    </p>
...
while($row = mysqli_fetch_assoc($result)) { ?>
    ...
    <div class="product">
        ...
        <div class="books">
            ...
            <div class="end-text"> <a class="link" href="updateproduct.php?id=<?php echo $row["id"]; ?>">update</a>
<a class="link" href="removeproduct.php?id=<?php echo $row["id"]; ?>">remove</a>
