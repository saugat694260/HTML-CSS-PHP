...
email='".$email."',user_name='".$user_name."',password='".$password."' where id='".$id."'";
// echo "$update";
mysqli_query($con, $update) or die(mysqli_error($con));
$status = "Record Updated Successfully. </br></br>
<a href='members.php'>View Updated Record</a>";
...
?>
    ...
    <div class="header">
        ...
        <div class="left"><a href="index.php"><img class="logo" src="New folder/images.jpg"></a>
            <p class="logo1">totally legal books</p>
        </div>
        <div class="right">

            <div class="login"><a href="profile.php"><img class="logo" src="New folder/download.jpg"></a>
            </div>
